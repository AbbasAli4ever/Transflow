...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:gap-4 lg:px-6">
        ...
        <div
          ...
          } items-center justify-between w-full gap-4 px-5 py-4 lg:flex lg:w-auto lg:flex-none shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none`}
        >
